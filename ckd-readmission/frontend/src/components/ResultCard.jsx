...
export default function ResultCard({ result, onReset }) {
  ...
  return (
    <div className="summary-page-layout">
      ...
      {/* Offline Estimate Banner */}
      {result.source === "offline_estimate" && (
        <div
          className="summary-blank-notice-bar"
          style={{ borderColor: "#f59e0b", background: "rgba(245, 158, 11, 0.12)", color: "#fbbf24", marginBottom: "1rem" }}
        >
          <svg
            width="18"
            height="18"
          ...
          <span>
            <strong>Offline Estimate Mode:</strong> Remote prediction server was unreachable. This risk score was calculated locally using client-side clinical decision support rules.
          </span>
        </div>
      )}
