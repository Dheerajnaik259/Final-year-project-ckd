...
export default function ResultCard({ result, onReset }) {
  ...
  return (
    <div className="summary-page-layout">
      ...
      {/* Offline Estimate Disclosure Banner */}
      {(result.source === "offline_estimate" || result.source === "client_engine") && (
        <div className="summary-offline-notice-bar">
          <svg
            width="18"
            height="18"
            viewBox="0 0 24 24"
          ...
          <div className="offline-notice-text">
            <span className="offline-badge-pill">Offline Estimate Mode</span>
            <span>
              Calculated using client-side clinical decision rules (remote backend server offline).
            </span>
          </div>
        </div>
      )}
